-- =============================================================================
-- [ALL-IN-ONE] F3X PRO V5 SYSTEM: INTRO CINEMATIC + SYSTEM TOOL STEP 2
-- Verified Framework & Mobile Setup Workspace Compatible
-- =============================================================================
...
-- =============================================================================
-- [PART 1]: INITIALIZE STEP 2 CORE PHYSICS TOOL (Keep hidden inside internal setup)
-- =============================================================================
local function InitializeF3XPhysicsTool()
	-- 1. Create Tool Instance
	local tool = Instance.new("Tool")
	tool.Name = "🛠️ F3X Pro (Physics)"
	...
	-- Check Part Validity & Physics Compatibility
	...
	-- 3. Click Detection & Target Setup
	...
	-- 4. Drag Mechanism (Move) & Camera Lock
	...
	-- 5. Drag Mechanism (Rotate) & Camera Lock
...
-- =============================================================================
-- [PART 2]: INTRO CINEMATIC SYSTEM WITH EN/TH SWITCHER (STEPS 1)
-- =============================================================================

-- 1. Create Main Screen Canvas
...
-- Calculate Diagonal Magnitude for Blade Animation
...
-- Post-Intro Informational Dialog Frame
...
-- Initialize as English (EN) Default
...
-- =============================================================================
-- [PART 3]: SYSTEM TIMELINE TRACKER CONTROL LOOP
-- =============================================================================
task.spawn(function()
	-- PHASE 1: Blades Slice In
	...
	-- PHASE 5: Deploy Informational Dialog Box
	...
	-- Action Trigger: Close Window and Execute Step 2 Physics Core
	local connection
	connection = closeBtn.MouseButton1Click:Connect(function()
		...
		-- ⚡ TRIGGER STEP 2: ส่งต่อตัวแปรและเรียกใช้งานระบบปืน F3X Pro V5 ทันที!
